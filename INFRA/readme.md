...
- Для ВМ: ASTRA   Client 01 и 02 необходимо дополнительно: установить xRDP, добавить в автозагрузку и запустить. У данных ВМ помимо SSH доступа, должно быть подключение и по 3389, а это значит - что для них важно установить графический рабочий стол fly-dm (на этапе установки ОС из загрузочного образа).
---
