    ...
    items: [
      {
        ...
        ip: "172.25.30.12",
        ssh: { enabled: true, host: "172.25.30.12", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        desc: "СИСТЕМА ПРЕДОТВРАЩЕНИЯ УТЕЧЕК ИНФОРМАЦИИ",
        ip: "172.25.30.13",
        ssh: { enabled: true, host: "172.25.30.13", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        desc: "СИСТЕМА ПРЕДОТВРАЩЕНИЯ УТЕЧЕК ИНФОРМАЦИИ",
        ip: "172.25.30.14",
        ssh: { enabled: true, host: "172.25.30.14", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.30.11",
        ssh: { enabled: true, host: "172.25.30.11", port: 22, user: "astra" },
        rdp: {  enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.30.16",
        ssh: { enabled: true, host: "172.25.30.16", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.30.2",
        ssh: { enabled: true, host: "172.25.30.2", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.30.3",
        ssh: { enabled: false  },
        rdp: { enabled: true, host: "172.25.30.3", port: 3389, user: "Администратор"}
      }
    ]
  },
    {
    ...
    items: [
      {
        ...
        ip: "172.25.30.110",
        ssh: { enabled: true, host: "172.25.30.110", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.30.4",
        ssh: { enabled: true, host: "172.25.30.4", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ssh: { enabled: false },
        rdp: { enabled: false },
        info: "smb://172.25.30.252/DISTRIB/",
        infoType: "smb"
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.30.101",
        ssh: { enabled: true, host: "172.25.30.101", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.31.101",
        ssh: { enabled: true, host: "172.25.31.101", port: 22, user: "astra" },
        rdp: { enabled: false }
      }
    ]
  },
    ...
    items: [
      {
        ...
        ip: "172.25.30.102",
        ssh: { enabled: false },
        rdp: { enabled: true, host: "172.25.30.102", port: 3389, user: "windows" }
      }
    ]
  }
];
